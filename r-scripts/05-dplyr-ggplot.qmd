...
ggplot2::ggplot(data=FactCockleSize, #what data table to use
                mapping=aes(x=length_mm, y=thickness_mm)) + geom_point()   #what is on the axes
...
ggplot2::ggplot(data=FactCockleSize, #what data table to use
  ...
  geom_smooth(method="lm")#what is on the axes
...
ggplot2::ggplot(data=FactCockleSize, #what data table to use
                mapping=aes(x=length_mm,y=thickness_mm)) + geom_point(mapping=aes(col=year)) +
  geom_smooth(method="lm") +#what is on the axes
facet_wrap(~year)

#option two
data=FactCockleSize, |>#what data table to use
  dplyr::filter(year %in% c(2014,2015,2017,2018,2020,2021)) |>
  droplevels() |>
  ggplot2::ggplot(mapping=aes(x=length_mm,y=thickness_mm)) + geom_point(mapping=aes(col=year)) +
  geom_smooth(method="lm") +#what is on the axes
facet_wrap(~year)
